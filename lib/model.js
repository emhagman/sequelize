...
var validateIncludedElements = function(options, tableNames) {
  ...
  if (options.includeAlias && !Model.whereCache[options.includeAlias]) {
    Model.whereCache[options.includeAlias] = options.where;
  }

  if (options.includeAlias && Model.includeCache[options.includeAlias]) {
    var opts = Model.includeCache[options.includeAlias];
    _.assign(options, opts);
    if (Model.whereCache[options.includeAlias]) {
      options.where = Model.whereCache[options.includeAlias];
    }
    return;
  }
  ...
  if (options.includeAlias) {
    Model.includeCache[options.includeAlias] = options;
  }
};
Model.$validateIncludedElements = validateIncludedElements;

validateIncludedElement = function(include, tableNames) {
